...
// readOnly is always true — triage history is read-only; no approve/reject handlers
...
export const ClusterCard = forwardRef<
  ClusterCardHandle,
  { cluster: Cluster; readOnly?: boolean }
>(
  function ClusterCard({ cluster, readOnly = true }, ref) {
